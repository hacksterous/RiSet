...
DECLARE FUNCTION mjdFn# (y AS INTEGER, m AS INTEGER, d AS INTEGER, h AS DOUBLE)
...
DEFSNG A-Z
FUNCTION mjdFn# (y AS INTEGER, m AS INTEGER, d AS INTEGER, h AS DOUBLE)
...
END IF
a# = 365# * y - 679004#
mjdFn = a# + b + ipart(30.6001# * (m + 1)) + d + h / 24
END FUNCTION
